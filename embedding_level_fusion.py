...
# =============================================================
# Embedding-Level Fusion Class
# =============================================================
class EmbeddingLevelFusionClassifier(nn.Module):
...
# Initialize Model
# =============================================================
model = EmbeddingLevelFusionClassifier(TEXT_MODEL_NAME, NUM_CLASSES, DROPOUT, PROJ_DIM).to(DEVICE)
...
print('Embedding-level fusion model evaluation on test set:')
...
# Save Best Model
# =============================================================
torch.save(best_model_state, 'best_embedding_level_model.pth')
